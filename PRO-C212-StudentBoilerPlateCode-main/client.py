...
def browseFiles():
    ...
    try:
        ...
        if(message[:4]=="send"):
            ...
            SERVER.send(final_message.encose())
...
def sendMessage():
    ...
    if(msgtosend=="y"or msgtosend=="y"):
        textarea.insert(END,"\n"+"\nplease wait file is dowloading......")
        textarea.see("end")
        HOSTNAME="127.0.0.1"
        USERNAME="lftpd"
        PASSWORD="lftpd"
        ...
        local_filename=os.path.join(download_path,Frame)
        ...
        textarea.insert(END,"\n"+"file succesfully download to path:"+download_path)
